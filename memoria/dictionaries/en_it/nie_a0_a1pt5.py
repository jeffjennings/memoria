...
vocab = {
    ...
    "ch5": {
        ...
        "prepositions": {
            ...
            "next to (2 forms)": "accanto / vicino",
    ...
    "ch7": {
        ...
        "verbs": {
            ...
            "to be (inf., irr. past participle)": "essere, sono stato",            
            "to be, to stay (inf., irr. past participle)": "stare, sono stato",
            "to stay, to remain [2 verbs] (inf., irr. past participle)": "restare, sono restato; rimanere, sono rimasto",
            "to die (inf., irr. past participle)": "morire, sono morto",
            "to be born (inf., irr. past participle)": "nascere, sono nato",    
            "to go (inf., irr. past participle)": "andare, sono andato",            
            "to return (inf., irr. past participle)": "tornare, sono tornato",
            "to enter (inf., irr. past participle)": "entrare, sono entrato",
            "to exit (inf., irr. past participle)": "uscire, sono uscito",
            "to leave (inf., irr. past participle)": "partire, sono partito",
            ...
            "to arrive (inf., irr. past participle)": "venire, sono venuto",
            "to open (inf., irr. past participle)": "aprire, ho aperto",
            "to close (inf., irr. past participle)": "chiudere, ho chiuso",
            "to drink (inf., irr. past participle)": "bere, ho bevuto",
            "to ask (inf., irr. past participle)": "chiedere, ho chiesto",
            "to run (inf., irr. past participle)": "correre, ho corso",
            "to decide (inf., irr. past participle)": "decidere, ho deciso",
            "to say/tell (inf., irr. past participle)": "dire, ho detto",
            "to discuss (inf., irr. past participle)": "discutere, ho discusso",
            "to do (inf., irr. past participle)": "fare, ho fatto",
            "to read (inf., irr. past participle)": "leggere, ho letto",
            "to put/place (inf., irr. past participle)": "mettere, ho messo",
            "to offer (inf., irr. past participle)": "offrire, ho offerto",
            "to lose (inf., irr. past participle)": "perdere, ho perso",
            "to cry (inf., irr. past participle)": "piangere, ho pianto",
            "to laugh (inf., irr. past participle)": "ridere, ho riso",
            "to smile (inf., irr. past participle)": "sorridere, ho sorriso",
            "to take (inf., irr. past participle)": "prendere, ho preso",
            "to promise (inf., irr. past participle)": "promettere, ho promesso",
            "to reply/respond (inf., irr. past participle)": "rispondere, ho risposto",
            "to break (inf., irr. past participle)": "rompere, ho rotto",
            "to choose (inf., irr. past participle)": "scegliere, ho scelto",
            "to write (inf., irr. past participle)": "scrivere, ho scritto",
            "to pay/spend (inf., irr. past participle)": "spendere, ho speso",
            "to see (inf., irr. past participle)": "vedere, ho visto",
            "to win/defeat (inf., irr. past participle)": "vincere, ho vinto",
            "to live (inf., irr. past participle)": "vivere, ho vissuto",
            "to hate": "odiare",
            "to walk": "camminare",
            "to decide": "decidere",
        },
...
phrases = {
    ...
    "ch7": {
        ...
        "How long does it take by train?": "Quanto tempo ci vuole con il treno?",
