...
vocab = {
    ...
    'ch7':{
        ...
        'island/isle':'isola',
        'cost':'costa',
        'the day before yesterday, last night':"l'altro ieri, ieri sera",
        'last Thursday, last month, two weeks ago, a year ago':'Giovedì scorso, il mese scorso, due settimane fa, un anno fa',
        'before class, after class':'prima della lezione, dopo la lezione',
        'already, just, never, yet, suddenly, immediately':'già, appena, mai, ancora, improvvisamente, subito',
