...
vocab = {
    ...
    "ch5": {
        ...
        "verbs": {
            ...
            "to lose (misplace) / to miss (an appointment, train, etc.)": "perdere",
            "to find": "trovare",
        },
        "adverbs": {
    ...
    "ch7": {
        ...
        "verbs": {
            ...
            "to hate": "odiare",
            "to walk": "camminare",   
            "to stay, to remain [2 verbs]": "rimanere, restare",         
            "to be (inf., irr. past participle)": "essere, sono stato",            
            "to stay, to remain [the form w/ irr. past participle] (inf., irr. past participle)": "rimanere, sono rimasto",
            ...
            "to lose [misplace] (inf., irr. past participle)": "perdere, ho perso",
            ...
            "to pay/spend [the form w/ irr. past participle] (inf., irr. past participle)": "spendere, ho speso",
