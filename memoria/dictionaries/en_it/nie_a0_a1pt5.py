...
vocab = {
    ...
    'ch3':{
        ...
        'first, secondo, third':'primo, secondo, terzo',
        'sport':'sport (m.)',
        'movie':'film (m.)',
        'theater, cinema':'teatro, cinema',
    ...
    'ch4':{
        ...
        'to ski, to snowboard':'sciare, fare snowboard',
        ...
        'to visit (a city, a museum)':'visitare (una città, un museo)',
        'to stop/to finish':'finire',
        'to like':'piacere',
        'to prefer':'preferire',
        'to clean':'pulire',
        'to know, to know/to be able':'conoscere, sapere',
        'to hear/to feel':'centire',
    ...
    'ch6':{
        ...
        'Names of the seasons':'inverno, primavera, estate (f.), autonno',
        ...
        'yesterday, today, tomorrow, day after tomorrow':'ieri, oggi, domani, dopodomani',
        'this morning (afternoon, evening), tonight, tomorrow morning (2 forms)':'stamattina, oggi pomeriggio, stasera, stanotte, domani mattina / domattina'
    },  
...
phrases = {
    ...
    'ch4':{
        ...
        "It doesn't matter. (2 forms)":"Non importa.",
        "Whatever.":"Vabbe'.",
